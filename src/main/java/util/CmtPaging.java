...
public class CmtPaging {
	...
	public CmtPaging(int totalCount, int curPage) {
	...
	public CmtPaging(int totalCount) {
		setTotalCount(totalCount);

		makePaging();
	}

	public CmtPaging(int totalCount, int curPage, int listCount) {
		setTotalCount(totalCount);
		setCurPage(curPage);
	...
	public CmtPaging(int totalCount, int curPage, int listCount, int pageCount) {
		setTotalCount(totalCount);
		setCurPage(curPage);
		setListCount(listCount); // 화면에 보여질 게시글 개수 지정하기
